        ...
        <div class="card card-body content_search">
            <div class="row">
                <div class="col-md-4 col-xl-6 py-1">
                    <form>
                        <input type="text" class="form-control product-search pad_search" id="input-search" placeholder="Búsqueda de Autorizaciones">
                    </form>
                </div>
            </div>
        </div>
            ...
            <table class="data_table">
                <thead>
                    <tr>
                        ...
                        <th class="txt_blue_light">{{ __('trans.service') }}</th>
                        <th class="no-sort"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Electrocardiograma</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Fisioterapia de Rehabilitación</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
