        ...
        <div class="main_target_form">
            <div class="form_row">
                ...
                <div class="col-12 data_row_form">
                    ...
                    <div class="col-md-6 data_group_form">
                        <label for="models" style="width: 100%">{{ __('validation.attributes.models') }}</label>
                            ...
                            <div class="col-md-6 mb-3 pr-0 pl-0 mb-md-0 pr-md-2">
                                ...
                                <div class="row row_input_radio">
                                    <div class="col-5 col-xl-3 content_input_radio @error('is_various') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="is_various-1" value="1" name="is_various" {{ (old('is_various') == 1) ? 'checked':'' }}> 
                                        <label class="form-check-label" for="is_various-1">{{ __('manager.yes') }}</label>
                                    </div>
                                    
                                    <div class="col-5 col-xl-3 content_input_radio @error('is_various') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="is_various-0" value="0" name="is_various" {{ (old('is_various') == 0) ? 'checked':'' }}> 
                    ...
                    <div class="col-md-6 data_group_form"> <!-- Input type radius -->
                        <div class="row m-0">
                            <div class="col-md-6 mb-3 pr-0 pl-0 mb-md-0 pr-md-2">
                                ...
                                <div class="row row_input_radio">
                                    <div class="col-5 col-xl-3 content_input_radio form-check form-check-inline @error('end_records') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="end_records-1" name="end_records" value="1" {{ (old('end_records') == 1) ? 'checked':'' }}> 
                                        <label class="form-check-label" for="end_records-1">{{ __('trans.active') }}</label>
                                    </div>

                                    <div class="col-5 col-xl-3 content_input_radio for-check form-check-inline @error('end_records') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="end_records-0" name="end_records" value="0" {{ (old('end_records') == 0) ? 'checked':'' }}>
                            ...
                            <div class="col-md-6 pl-0 pr-0 pl-md-2">
                                ...
                                <div class="row row_input_radio">
                                    <div class="col-5 col-xl-3 content_input_radio form-check form-check-inline @error('required') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="required-1" name="required" value="1" {{ (old('required') == 1) ? 'checked':'' }}>
                                        <label class="form-check-label" for="required-1">{{ __('manager.yes') }}</label>
                                    </div>

                                    <div class="col-5 col-xl-3 content_input_radio form-check form-check-inline @error('required') is-invalid @enderror">
                                        <input class="mr-1" type="radio" id="required-0" name="required" value="0" {{ (old('required') == 0) ? 'checked':'' }}>
