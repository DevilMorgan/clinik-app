                    ...
                    <div class="card w-100">
                        ...
                        <div class="card-img-overlay" style="height: 110px">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <small class="card-text text-white fw-light"
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-xl-8">
                    <div class="card">
                        <!-- Nav tabs -->
                        <ul
                            class="nav nav-tabs profile-tab nav-justified"
                            role="tablist"
                        >
                            <li class="nav-item">
                                <a
                                ...
                                >
                                    ...
                                    ></i>
                                    <span class="d-none d-md-inline-block fw-normal"
                                    >Activity</span
                                    >
                                </a>
                            </li>
                                            ...
                                            <div class="sl-right">
                                                <div>
                                                    <div class="d-md-flex align-items-center">
                                                        ...
                                                        <span class="sl-date text-muted ms-1"
                                                        >5 minutes ago</span
                                                        >
                                                    </div>
                                                    ...
                                                    <div class="text-nowrap">
                                                        <a
                                                            href="javascript:void(0)"
                                                            class="link me-2 font-weight-medium"
                                                        ><i
                                                                data-feather="message-circle"
                                                                class="fill-white feather-sm text-info"
                                                            ></i>
                                                            comments</a
                                                        >
                                                        <a
                                                        ...
                                                        ><i
                                                                data-feather="heart"
                                                                class="fill-white feather-sm text-danger"
                                                            ></i>
                                                            5 Likes</a
                                                        >
                                                    </div>
