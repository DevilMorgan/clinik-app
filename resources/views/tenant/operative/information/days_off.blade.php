...
@section('content')
    <nav aria-label="breadcrumb">
        <nav aria-label="breadcrumb" class="agenda_path">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">{{ __('trans.days_off') }}</a></li>
            </ol>
        </nav>
    </nav>
    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-12">
                <table id="days-off-table" class="display nowrap my-3" style="width:100%">
                    <thead>
                    <tr>
                        <th>ID</th>
            ...
            <div class="col-12">
                <a href="{{ route('tenant.operative.information.index') }}" class="btn btn-outline-info">
