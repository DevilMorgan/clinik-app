        ...
        <div class="card card-body content_search">
            <div class="row">
                <div class="col-md-4 col-xl-6 py-1">
                    <form>
                        <input type="text" class="form-control product-search pad_search" id="input-search" placeholder="Búsqueda de Incapacidades">
                    </form>
                </div>
            </div>
        </div>
            ...
            <table class="data_table">
                <thead>
                    <tr>
                        ...
                        <th class="txt_blue_light">{{ __('trans.disabilities_type') }}</th>
                        <th class="no-sort"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Nueva</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Prórroga</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Examen de Laboratorio</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Licencia de Maternidad</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
