            ...
            <div class="form_row">
                ...
                <div class="col-12 data_row_form">
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('name') is-invalid @enderror" id="name" name="name"  value="{{ old('name', $models_medical_history->name) }}">
                    </div>
                        ...
                        <div class="pr-0 pl-0 pr-md-2">
                            ...
                            <div class="row row_input_radio">
                                <div class="col-5 col-xl-3 content_input_radio @error('status') is-invalid @enderror">
                                    <input class="mr-1" type="radio" id="status-1" value="1" name="status" {{ (old('status', $models_medical_history->status) == 1) ? 'checked':'' }}>
                                     <label class="form-check-label" for="status-1">{{ __('trans.active') }}</label>
                                </div>
                                
                                <div class="col-5 col-xl-3 content_input_radio @error('status') is-invalid @enderror">
                                    <input class="mr-1" type="radio" id="status-0" value="0" name="status" {{ (old('status', $models_medical_history->status) == 0) ? 'checked':'' }}>
