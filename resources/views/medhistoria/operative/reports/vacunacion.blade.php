...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h2 class="txt_blue_bold mb-0">{{ __('trans.Vaccination') }}</h2>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item ">{{ __('trans.Vaccination') }}</li>
            </ol>
        </div>
        ...
        <div class="card card-body content_search">
            <div class="row">
                <div class="col-md-4 col-xl-6 py-1">
                    <form>
                        <input type="text" class="form-control product-search pad_search" id="input-search" placeholder="Búsqueda de Vacunación">
                    </form>
                </div>
            </div>
        </div>
            ...
            <table class="data_table">
                <thead>
                    <tr>
                        ...
                        <th class="txt_blue_light">{{ __('trans.scheme') }}</th>
                        <th class="no-sort"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Segunda dosis PFIZER - COVID-19</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Primera dosis PFIZER - COVID-19</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Influenza</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
                    ...
                    <tr>
                        ...
                        <td class="pt-4 pb-3">
                            <span class="txt_blue_300 fs-9">Fiebre Amarilla</span>
                        </td>
                        <td class="pad_icon_table pt-4 pb-3">
                            <a href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ver información">
                                <i data-feather="eye" class="icon_info"></i>
