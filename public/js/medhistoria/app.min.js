      ...
      )),
      {
        ...
        ManageSidebarPosition: function () {
          ...
          switch (t.Layout) {
            ...
            case "horizontal":
              1 == a
                ? ($("#" + i).attr("data-sidebar-position", "fixed"),
                  $("#sidebar-position").prop("checked", !0))
                : ($("#" + i).attr("data-sidebar-position", "absolute"),
                  $("#sidebar-position").prop("checked", !1)),
                1 == e
                  ? ($("#" + i).attr("data-header-position", "fixed"),
                    $("#header-position").prop("checked", !0))
                  : ($("#" + i).attr("data-header-position", "relative"),
  ...
  $(function () {
    ...
    $("#chat .message-center a").on("click", function () {
      ...
      if ($(this).hasClass("active"))
        $(this).toggleClass("active"), $(".chat-windows #user-chat" + t).hide();
      else if (
        ($(this).toggleClass("active"),
        $(".chat-windows #user-chat" + t).length)
      )
      ...
      $(document).on(
        ...
        function (a) {
          ...
          $(".chat-windows #user-chat" + e).hide(),
            $("#chat .message-center .user-info#chat_user_" + e).removeClass(
              "active"
            );
        }
      ),
      ...
      $(document).on(
        ...
        function (a) {
          if (13 == a.keyCode) {
            ...
            (t = msg_sent(t)),
              $(
                ".chat-windows #user-chat" + e + " .chat-body .chat-list"
              ).append(t),
              $(this).val(""),
              $(this).focus();
          }
