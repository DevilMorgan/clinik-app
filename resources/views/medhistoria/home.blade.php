                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a  href="https://zaabrasalud.co/" target="_blank">
                                <div class="card p-4">
                                    <img src="{{ asset('img/medhistoria') }}/logos/Zaabra-Salud-logo.jpg" alt="" class="m-auto" width="124">
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch"> 
                            <div class="card w-100">
                                <div class="card-header bg-success perfil_pad_card_sed_contac">
                                    <h3 class="text-white fw_bold fs-10 m-0">{{ __('trans.my_patient') }}</h3>
                                    <a href="javascript:void(0)" class="btn btn-info fs-4 perfil_positionBtn_card_row2">{{ __('trans.see_patient') }}</a>
                                </div>
                            ...
                            <div class="card w-100">
                                <div class="card-body perfil_pad_card_citas">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="card-title txt_blue_bold fs-10 m-0">{{ __('trans.upcoming_appointment') }}</h3>
                                        <a href="javascript:void(0)" class="btn btn-info fs-4">{{ __('trans.see_appointment') }}</a>
                                    </div>
                            ...
                            <div class="card w-100">
                                <div class="card-body perfil_pad_card_citas">
                                    <div class="d-flex justify-content-between ps-4 pe-5">
                                        <h3 class="card-title txt_blue_bold fs-11 m-0">{{ __('trans.my_clinic_history') }}</h3>
                                        <a href="javascript:void(0)" class="btn btn-info fs-9">{{ __('trans.see_clinic_history') }}</a>
                                    </div>
                                    <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 d-flex align-items-stretch"> 
                        <div class="card bg__blue_light w-100">
                            <div class="card-body perfil_pad_card_citas">
                                <div class="d-flex justify-content-between">
                                    <h3 class="txt_white_bold fs-10 m-0">{{ __('trans.second_user') }}</h3>
                                    <a href="javascript:void(0)" class="btn btn-info fs-4">{{ __('trans.see_user') }}</a>
                                </div>
