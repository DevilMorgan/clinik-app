        ...
        <div class="main_target_form">
            <div class="form_row">
                ...
                <div class="col-8 col-md-3 col-xl-2 imgUser_container_form">
                    <img src="{{ isset($patient->photo) ? asset('tenancy/' . $patient->photo) : '' }}" alt="" class="img_user_form" id="img-photo">
                ...
                <div class="col-12 col-md-9 col-xl-10 data_row_form">
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('id_card') is-invalid @enderror" id="id_card" name="id_card" required value="{{ old('id_card', $patient->id_card) }}">
                    </div>
                </div>
                        ...
                        <div class="pr-0 pl-0">
                            ...
                            <div class="row row_input_radio">
                                <div class="col-5 col-xl-3 content_input_radio @error('status-medical') is-invalid @enderror">
                                    <input class="mr-2" type="radio" id="status-medical-1" value="1" name="status-medical" {{ (old('status-medical', $patient->status_medical) == 1) ? 'checked':'' }}>
                                    <label class="form-check-label" for="status-medical-1">{{ __('trans.active') }}</label>
                                </div>

                                <div class="col-5 col-xl-3 content_input_radio @error('status-medical') is-invalid @enderror">
                                    <input class="mr-2" type="radio" id="status-medical-0" value="0" name="status-medical" {{ (old('status-medical', $patient->status_medical) == 0) ? 'checked':'' }}>
                                    <label class="form-check-label" for="status-medical-0">{{ __('trans.inactive') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="pr-0 pl-0 mt-0 mt-md-2">
                            ...
                            <div class="row row_input_radio">
                                <div class="col-5 col-xl-3 content_input_radio @error('status') is-invalid @enderror">
                                    <input class="mr-2" type="radio" id="status-1" value="1" name="status" {{ (old('status', $patient->status) == 1) ? 'checked':'' }}>
                                    <label class="form-check-label" for="status-1">{{ __('trans.active') }}</label>
                                </div>

                                <div class="col-5 col-xl-3 content_input_radio @error('status') is-invalid @enderror">
                                    <input class="mr-2" type="radio" id="status-0" value="0" name="status" {{ (old('status', $patient->status) == 0) ? 'checked':'' }}>
