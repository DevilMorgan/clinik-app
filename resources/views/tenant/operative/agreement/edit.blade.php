            ...
            <div class="form_row">
                ...
                <div class="col-12 data_row_form">
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $agreement->name) }}">
                    </div>

                    <div class="col-md-6 data_group_form">
                        <label for="code">{{ __('validation.attributes.code') }}</label>
                        <input type="text" class="input_dataGroup_form @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $agreement->code) }}">
                    </div>
                </div>
            </div>
