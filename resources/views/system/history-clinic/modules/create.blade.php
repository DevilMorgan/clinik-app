...
@section('content')
    <section class="container">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{ route('system.history-clinic.modules.store') }}" method="post" id="form-templates-create">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select name="type" id="type" class="form-control">
                                ...
                                <option value="segmented" {{ old('type') == 'segmented' ? 'selected':'' }}>Segmentado</option>
                            </select>
                        </div>
                        <div class="col-auto mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="is_required-1" name="is_required"
                                       value="1" {{ old('is_required') == 1 ? 'checked':'' }} />
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="is_required-0" name="is_required"
                                       value="0" {{ old('is_required') == 0 ? 'checked':'' }} />
                        ...
                        <div class="col-auto mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="is_end_records-1" name="is_end_records"
                                       value="1" {{ old('is_end_records') == 1 ? 'checked':'' }} />
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="is_end_records-0" name="is_end_records"
                                       value="0" {{ old('is_end_records') == 0 ? 'checked':'' }} />
