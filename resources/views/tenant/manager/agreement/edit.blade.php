                ...
                <div class="col-12 data_row_form">
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('name') is-invalid @enderror"
                               id="name" name="name" value="{{ old('name', $agreement->name) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('second_name') is-invalid @enderror"
                               id="second_name" name="second_name" value="{{ old('second_name', $agreement->second_name) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('first_lastname') is-invalid @enderror"
                               id="first_lastname" name="first_lastname" value="{{ old('first_lastname', $agreement->second_name) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('second_lastname') is-invalid @enderror"
                               id="second_lastname" name="second_lastname" value="{{ old('second_lastname', $agreement->second_name) }}">
                    </div>

                    <div class="col-md-6 data_group_form">
                        <label for="email">{{ __('validation.attributes.email') }}(*)</label>
                        <input type="email" class="input_dataGroup_form @error('email') is-invalid @enderror"
                               id="email" name="email" value="{{ old('email', $agreement->email) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="email" class="input_dataGroup_form @error('email_optional') is-invalid @enderror"
                               id="email_optional" name="email_optional" value="{{ old('email_optional', $agreement->email_optional) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('code') is-invalid @enderror"
                               id="code" name="code" value="{{ old('code', $agreement->code) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <select class="input_dataGroup_form" id="type_card" name="type_card" required>
                            ...
                            @foreach($card_types as $item)
                                <option value="{{ $item->id }}" {{ old('type_card', $agreement->card_type_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->name_short }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('id_card') is-invalid @enderror"
                               id="id_card" name="id_card" required value="{{ old('id_card', $agreement->id_card) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('code_agreement') is-invalid @enderror"
                               id="code_agreement" name="code_agreement" value="{{ old('code_agreement', $agreement->code_agreement) }}">
                    </div>
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('country') is-invalid @enderror country"
                               id="country" name="country" required value="{{ old('country', $agreement->country) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('department') is-invalid @enderror department"
                               id="department" name="department" required value="{{ old('department', $agreement->department) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('city') is-invalid @enderror city"
                               id="city" name="city" required value="{{ old('city', $agreement->city) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('neighborhood') is-invalid @enderror"
                               id="neighborhood" name="neighborhood" value="{{ old('neighborhood', $agreement->neighborhood) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('address') is-invalid @enderror"
                               id="address" name="address" value="{{ old('address', $agreement->address) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <select class="input_dataGroup_form" id="address_type" name="address_type" >
                            <option value="house" {{ old('address_type', $agreement->address_type) == 'house' ? 'selected':'' }}>{{ __('trans.house') }}</option>
                            <option value="office" {{ old('address_type', $agreement->address_type) == 'office' ? 'selected':'' }}>{{ __('trans.office') }}</option>
                            <option value="surgery" {{ old('address_type', $agreement->address_type) == 'surgery' ? 'selected':'' }}>{{ __('trans.surgery') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('postcode') is-invalid @enderror"
                               id="postcode" name="postcode" value="{{ old('postcode', $agreement->postcode) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <input type="text" class="input_dataGroup_form @error('economic_activity') is-invalid @enderror"
                               id="economic_activity" name="economic_activity" value="{{ old('economic_activity', $agreement->economic_activity) }}">
                    </div>
                    ...
                    <div class="col-md-6 data_group_form">
                        ...
                        <select class="input_dataGroup_form" id="business_type" name="business_type" >
                            <option value="private" {{ old('business_type', $agreement->business_type) == 'private' ? 'selected':'' }}>{{ __('trans.private') }}</option>
                            <option value="public" {{ old('business_type', $agreement->business_type) == 'public' ? 'selected':'' }}>{{ __('trans.public') }}</option>
                            <option value="mix" {{ old('business_type', $agreement->business_type) == 'mix' ? 'selected':'' }}>{{ __('trans.mix') }}</option>
                        </select>
                    </div>
                </div>
            </div>
